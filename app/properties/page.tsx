...
export default function PropertiesPage() {
  ...
  const applyFilters = () => {
    const filtered = allProperties.filter((property) => {
      ...
      // Bedrooms filter
      if (filters.bedrooms !== "all" && property.bedrooms !== Number.parseInt(filters.bedrooms)) {
        return false
      }

      // Bathrooms filter
      if (filters.bathrooms !== "all" && property.bathrooms < Number.parseInt(filters.bathrooms)) {
        return false
      }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-eureka-black mb-4">Properties</h1>
          <p className="text-lg text-gray-600">Find your perfect property from our extensive collection</p>
        </div>
            ...
            <Card className="sticky top-4">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <Button onClick={applyFilters} className="w-full bg-eureka-red hover:bg-red-700">
                    Apply Filters
                  </Button>
          ...
          <div className="lg:col-span-3">
                ...
                <Card key={property.id} className="overflow-hidden hover:shadow-lg transition-shadow">
                  ...
                  <CardContent>
                    <div className="flex justify-between items-center mb-4">
                      <span className="text-2xl font-bold text-eureka-red">{property.priceDisplay}</span>
                    </div>
                  ...
                  <CardFooter>
                    <Link href={`/properties/${property.id}`} className="w-full">
                      <Button className="w-full bg-eureka-black hover:bg-gray-800">View Details</Button>
                    </Link>
                  </CardFooter>
                </Card>
              ))}
            ...
            {filteredProperties.length === 0 && (
              <div className="text-center py-12">
                ...
                <Button onClick={resetFilters} className="mt-4 bg-eureka-red hover:bg-red-700">
                  Reset Filters
                </Button>
              </div>
            )}
